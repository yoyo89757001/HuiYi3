...
import com.ruitong.huiyi3.beans.AllUserBean;
import com.ruitong.huiyi3.beans.BaoCunBean;
import com.ruitong.huiyi3.beans.BaoCunBeanDao;
import com.ruitong.huiyi3.beans.ChuanJianUserBean;
import com.ruitong.huiyi3.beans.MoShengRenBean;
import com.ruitong.huiyi3.beans.MoShengRenBean2;
...
import com.ruitong.huiyi3.beans.TuPianBean;
import com.ruitong.huiyi3.beans.User;
import com.ruitong.huiyi3.beans.WBBean;
import com.ruitong.huiyi3.beans.WeiShiBieBean;
import com.ruitong.huiyi3.box2d.Box2DFragment;
...
//					}
				...
				public void onError(Exception e) {
					Log.d("WebsocketPushMsg8", "onError"+e.getMessage());
		...
		call.enqueue(new Callback() {
			...
			public void onResponse(final Call call, Response response) throws IOException {
				...
				Log.d("VlcVideoActivity", "删除照片:" + XinChunActivity.this.deleteFile(fname));
					...
					Log.d("WebsocketPushMsg5", e.getMessage());
				}
			}
		...
		call.enqueue(new Callback() {
			...
			public void onResponse(Call call, Response response) throws IOException {
				...
				//	moShengRenBean2.setUrl("http://192.168.2.7:8080/sign?cmd=signScan&subjectId="+zhaoPianBean.getId());
					...
					Log.d("WebsocketPushMsg4", e.getMessage());
				}
...
//					link_houtai(zhaoPianBean);
					...
					Log.d("WebsocketPushMsg3", e.getMessage());
				}
			}
		});
